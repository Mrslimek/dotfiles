...
async def handle_inn(message: Message, inn: str) -> None:
    ...
    await message.answer("⏳ Ищу информацию по компании...")
...
async def handle_unknown_message(message: Message) -> None:
    help_text = (
        "Привет! Я бот для поиска информации по ИНН и ОГРН.\n\n"
        "Просто отправьте мне ИНН или ОГРН, "
        "и я найду информацию о компании.\n\n"
        "ОБЯЗАТЕЛЬНО ТУТ ДОБАВИТЬ ПРИМЕРЫ ПО ИНН И ОГРН\n"
        "Пример: 7728168971"
    )
